...
def test_e6_e7_defaults_match_atomic_action_tutorial_contracts() -> None:
    ...
    assert motion["Slide"] == {
        ...
        "interaction_grasp_minimum_support_clearance": pytest.approx(-0.01),
        "articulation_grasp_settle_steps": 80,
        "articulation_contact_overtravel": pytest.approx(0.01),
    ...
    assert motion["OpenDoor"] == {
        ...
        "articulation_progress_sync_tolerance": pytest.approx(0.01),
        "articulation_progress_sync_max_repeats": 50,
        "articulation_pregrasp_friction": pytest.approx(1.0),
        "articulation_motion_friction": pytest.approx(0.0),
        "articulation_holding_friction": pytest.approx(1.0),
